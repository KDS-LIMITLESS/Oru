...
class UserModel(db.Model):
    ...
    async def init(self, username, password, email, country: str, phone_number, state, city, *args):
        ...
        self.phone_number = await Country.get_user_phonenumber(Country, phone_number)
